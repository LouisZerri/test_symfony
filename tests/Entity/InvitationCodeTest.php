...
class InvitationCodeTest extends WebTestCase
{
    ...
    //Les 5 tests suivant | Dans le terminal : . . . . . 
    ...
    {
        $this->assertHasErrors($this->getEntity()->setCode('1a2345'), 1);
        $this->assertHasErrors($this->getEntity()->setCode('1235'), 1);
    }
